...
CXX_FLAGS      = '-Xpreprocessor -fopenmp -mcpu=apple-m1'
CMAKE_C_FLAGS  = ' -Wno-implicit-function-declaration'
MPIC_FLAGS     = ' -Wno-implicit-function-declaration'
MPICXX_FLAGS   = '-Xpreprocessor -fopenmp -mcpu=apple-m1'

BLAS_INCS      = '-I/opt/homebrew/Cellar/openblas/0.3.21/include'
BLAS_LIBS      = '-L/opt/homebrew/Cellar/openblas/0.3.21/lib -lopenblas'
LAPACK_LIBS    = '-L/opt/homebrew/Cellar/openblas/0.3.21/lib -lopenblas'
